<template>
    <div>
      ...
      <div x-data="postUpvote" class="rounded-xl bg-white p-4 dark:bg-slate-800">
        <div class="flex items-center justify-between">
          <div class="inline-flex items-center justify-start gap-2">
            <div class="flex flex-col gap-0.5">
              <a href="https://www.javadog.net/authors/hdxjhkhjc2012" title="Java程序员" class="text-sm font-semibold text-gray-900 hover:text-gray-600 dark:text-slate-100 dark:hover:text-slate-200">{{ article.user.username }}</a>
        ...
        <h1 class="my-3 text-2xl font-medium dark:text-slate-50">{{ article.title }}</h1>
...
<script setup>
   //1. 导入依赖  ref | onMounted -> vue || articleDetail -> article  || useRoute -> vue-router
   //2. 定义全局数据 顶一个article对象
   //3. 初始化周期方法 onMounted
   //4. 定义特定逻辑函数 没有
   ...
   const article = ref({
      ...
      title: "Spring轻量级框架",
      content: "spring",
      createTime: "2023-06-28 12:27:41",
      updateTime: "2023-06-28 12:27:41",
      user: {
        username: "lucy",
        password: "123456",
        phone: "13567890987",
        introduction: "334666777",
        createTime: "2023-06-28 12:27:41",
        updateTime: "2023-06-28 12:27:41",
        uid: 1
      },
